...
#stoy_story = media.Movie("toy Story", "A story of a boy and his toys that com to life",
	                     #"http://upload.wikimedia.org/wikipedia/en/1/12/Toy_story.jpg",
	                     #"https://ww.youtube.com/wath?v=vwyZH85NQC4")

#avatar = media.Movie("avatar", "A marine on an alien planet",
	                     #"http://upload.wikimedia.org/wikipedia/id/b/b0/avatar-Teaset-poster.jpg",
...
#RainMan = media.Movie("Rain Man", "Raymond, the autistic genius who directed artist Dustin Hoffman, who won the Oscars in 1989 for his role as the best actor, is the main actor.",
	                     #"http://upload.wikimedia.org/wikipedia/id/b/b0/Rain-Man-poster.jpg",
	                     #"https://youtu.be/mlNwXuHUA8I")

toy_story = media.Movie('TOY STORY' , 'A story of a boy and his toys that come to life','http://www.impawards.com/1995/posters/toy_story_ver1.jpg','https://www.youtube.com/watch?v=KYz2wyBy3kc')
#print(toy_story.poster_image_url)

avatar = media.Movie('AVATAR','alien planet','http://www.impawards.com/2009/posters/avatar_ver4.jpg','https://www.youtube.com/watch?v=5PSNL1qE6VY')
#print(avatar.storyline)
#print(avatar.poster_image_url)
#toy_story.show_trailer()

Finding_Nemo = media.Movie('Finding_Nemo','A clown fish named Marlin lives in the Great Barrier Reef loses his son','http://www.impawards.com/2003/posters/finding_nemo.jpg','https://www.youtube.com/watch?v=yDPRaVX2p8c')
